    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-blue-100 mb-8">Discover amazing places to call home</p>
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-4 flex flex-col md:flex-row gap-4">
            ...
            <button 
              ...
              className="flex items-center gap-2 px-6 py-3 bg-gray-50 rounded-xl text-gray-700 hover:bg-gray-100 transition"
            >
              <Filter size={20} />
              <span>Filters</span>
              <ChevronDown size={18} />
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4">
                  <span className="px-3 py-1 bg-white/90 backdrop-blur rounded-full text-sm font-semibold text-gray-800">
                    {property.type}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                {/* CTA Button */}
                <button className="w-full mt-4 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-semibold hover:from-blue-700 hover:to-indigo-700 transition shadow-lg">
                  View Details
                </button>
              </div>
            </div>
