...
function firstContent() {
    return (
        <div className="-mt-24 py-16" style={{ background: 'linear-gradient(180deg, #CBB59A 0%, #A8866A 100%)' }}>
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-12">
                    <p className="text-lg font-bold mt-12 mb-8 text-white">WHY CHOOSE PROP BOOKINGS FOR AGENTS</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="bg-transparent p-8 rounded-xl hover:shadow-md transition-shadow">
                        ...
                        <p className="text-gray-600">Check availability and create bookings in seconds</p>
                    </div>
                    <div className="bg-transparent p-8 rounded-xl hover:shadow-md transition-shadow">
                        <DollarSign className="w-12 h-12 text-blue-600 mb-4" />
                        <h3 className="text-xl font-semibold mb-2">Automatic Commissions</h3>
                        <p className="text-gray-600">Earn commissions on every successful booking</p>
                    </div>
                    <div className="bg-transparent p-8 rounded-xl hover:shadow-md transition-shadow">
                        <Users className="w-12 h-12 text-blue-600 mb-4" />
                        <h3 className="text-xl font-semibold mb-2">Client Management</h3>
                        <p className="text-gray-600">Generate payment links and track all your bookings</p>
                    </div>
                    <div className="bg-transparent p-8 rounded-xl hover:shadow-md transition-shadow">
                        <Users className="w-12 h-12 text-blue-600 mb-4" />
                        <h3 className="text-xl font-semibold mb-2">Client Management</h3>
                ...
                <div className="relative text-center h-screen w-full overflow-hidden flex items-center justify-center bg-transparent">
                    ...
                    <div className="relative z-4 w-full h-full block text-left px-4">
                        ...
                        <p className="text-2xl text-left text-white/95 mb-8 drop-shadow-md w-full mx-auto">
